...
/**
 * Jump list for navigating build modes.
 *
 * Borrowed from the Link Jump module, by @effulgentsia
 *
 * @param context
 */
Drupal.behaviors.dsBuildModeSelect = function(context) {
